...
- Piramide regionale: monumento/gameplay per regione → Fase 2 (oggi il monumento 3D è solo quello centrale; il ciclo classico Alleanze resta dormiente su gm_1).
...
- Premio Grande Piramide (Fase 2): proposta = Rubini + risorse + titolo "Custodi della Grande Piramide" alla regione, una sola volta per ciclo.
...
- Aperto (Fase 2): la Piramide **regionale** non ha ancora monumento/gameplay — il pulsante «centra sulla Piramide» con nebbia alta porta al centro geometrico della regione.
