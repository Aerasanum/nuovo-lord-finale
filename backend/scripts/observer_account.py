...
async def main() -> None:
    ...
    await db().players.update_one({"_id": player["_id"]}, {"$set": {"view_all_regions": True, "prestige": 60_000, "intro_seen_at": now, "shield_ended_at": now, "shield_end_reason": "QA_OBSERVER"}})
