...
async def spec_catalog():
    ...
    return {
        ...
        "economy": [s.economy[lvl] for lvl in range(1, 31)],
        "settlement_progression": [s.settlement_progression[lvl] for lvl in range(1, 31)],
        "walls": [s.walls[lvl] for lvl in range(1, 31)],
        "terrain": s.terrain,
